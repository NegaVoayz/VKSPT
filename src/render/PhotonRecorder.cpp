...
#include "render/FrameRecorder.h"  // for TracePushConstant
    ...
    int lightIndex, int photonsPerBatch, int totalBatches)
{
    ...
    dispatchPhotonTraceBatch(cb, as, pipeline,
    ...
    recordHashStages(cb, as, pipeline, photonsPerBatch);

    cb.end();
}

void PhotonRecorder::recordHashStages(
    vk::CommandBuffer cb,
    const AccelerationStructure& as, RayTracingPipeline& pipeline,
    int photonsPerBatch)
{
...
void PhotonRecorder::dispatchPhotonTraceBatch(
    vk::CommandBuffer cb,
    const AccelerationStructure& as, RayTracingPipeline& pipeline,
...
void PhotonRecorder::dispatchHashCount(
...
void PhotonRecorder::dispatchHashScan(
...
void PhotonRecorder::dispatchHashScatter(
    vk::CommandBuffer cb, RayTracingPipeline& pipeline, int photonCount)
{
    cb.bindPipeline(vk::PipelineBindPoint::eCompute,
...
void PhotonRecorder::dispatchHashAggregate(
    vk::CommandBuffer cb, RayTracingPipeline& pipeline)
{
    cb.bindPipeline(vk::PipelineBindPoint::eCompute,
